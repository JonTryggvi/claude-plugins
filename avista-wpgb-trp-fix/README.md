...
| [`avista-wpgb-trp-fix-overview/`](skills/avista-wpgb-trp-fix-overview/) | Prints a summary of this plugin — the bug it fixes, the skill, and how the fix works. Run `/avista-wpgb-trp-fix-overview` or ask "what does this plugin do?". |
